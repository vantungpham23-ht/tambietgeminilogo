...
const DOWNLOAD_ACTION_LABEL_PATTERN = /(download|copy|tải xuống|sao chép)/i;
const COPY_ACTION_LABEL_PATTERN = /(copy|sao chép)/i;
const EXPLICIT_DOWNLOAD_ACTION_LABEL_PATTERN = /(download|tải xuống)/i;
