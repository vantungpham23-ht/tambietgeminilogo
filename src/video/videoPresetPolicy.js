...
export function getRelocatedReviewPresetConfig() {
    return {
        id: 'relocated-review',
        label: '✨ AI xử lý tự động',
        description: 'Tự tìm logo rồi dùng AI model dọn sạch — bạn không cần chỉnh gì hết nha ♡',
...
export function getStandardAutoPresetConfig() {
    return {
        id: 'standard-auto',
        label: '✨ AI xử lý tự động',
        description: 'Mặc định dùng AI cục bộ xóa logo Gemini/Veo ở góc phải bên dưới.',
        alphaGain: DEFAULT_AUTO_ALPHA_GAIN,
        adaptiveAlpha: false,
        highQualityCleanup: DEFAULT_HIGH_QUALITY_CLEANUP,
